...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Anthony2004', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '是一个普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.anthony2004.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Anthony,2004', // 网站关键词 英文逗号隔开
